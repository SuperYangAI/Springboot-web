...
import com.actec.ms.utils.CookieUtils;
...
//		ConfigurationPage<String> p = new ConfigurationPage<String>(3, 3);
...
//	}
	...
	public static int calcuOffset(int pageNo, int pageSize) {
		int offset = 0;
		if(pageNo > 1) {
...
//	 */
//	public void setSpringPage(org.springframework.data.domain.ConfigurationPage<T> page){
